...
class Training:
    ...
    def get_distance(self):
        """Возвращает дистанцию, которую преодолел пользователь за тренировку"""
    ...
    def get_spent_calories(self):
        """Возвращает количество килокал., израсходованных за время тренировки"""
        pass
...
class Running(Training):
    ...
    def get_spent_calories(self):  # Расчёт калорий для этого класса
        ...
        spent_calories: float = ((coeff_calorie_1 * mean_speed - coeff_calorie_2)
